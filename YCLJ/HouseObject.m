...
- (void)setHouseModel:(HouseModel *)houseModel
{
    ...
    // 3, delete
    CGFloat imgDelX = SCREEN_WIDTH/2;
    ...
    CGFloat solutionX = SCREEN_WIDTH - solutionW - 20;
    ...
    // 5, split line
    _viSplitLineF = CGRectMake(20, CGRectGetMaxY(_labDateF) + kCell_Offset, SCREEN_WIDTH - 20, 0.5);
