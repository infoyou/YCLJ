...
@interface YCHouseCityChoiceView () <UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation YCHouseCityChoiceView
...
- (void)loadDatas
{
    NSString * path = [[NSBundle mainBundle] pathForResource:@"houseCity" ofType:@"plist"];
